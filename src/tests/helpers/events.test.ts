...
it('decodes event objects', async () => {
    ...
    expect(plainTextEvents).toBe({"invitedEvents": ["", {"date": "string", "description": "string", "invitees": ["user1", "user2", "user3"], "location": "string", "title": "string"}], "myEvents": ["", {"date": "string", "description": "string", "invitees": ["user1", "user2", "user3"], "location": "string", "title": "string"}]})
})
